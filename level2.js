var Level2 = {
    ...
    start: function () {
        ...
        this.createSpike(2, 606, 3);
        this.createFloor(4);
        this.createSpike(4.4, 606, 3);
        this.createFloor(6);
        this.createBrick(7.5, 500, 4);
        this.createBrick(8.25,500, 4);
        this.createFloor(9, 6);
        this.createBrick(9.7, 375, 4, 4);
        this.createSpike(9.75, 606, 2);

        this.createBrick(10.45, 375, 4, 4);
        this.createSpike(10.5, 606, 2);
        this.createBrick(11.2, 375, 4, 4);
        this.createSpike(11.25, 606, 2);
        this.createSpike(12, 606, 2);
        this.createSpike(12.55, 606, 5);
        this.createSpike(13.35, 606, 2);
        this.createSpike(13.9, 606, 5);
        ...
        this.createSpike(23.25, 468, 2); 
        this.createFloor(24, 3);
        this.createSpike(24.5, 606);
        this.createSpike(25, 606);
        this.createSpike(25.5, 606);
        this.createSpike(26, 606);
        this.createSpike(26.5, 606, 3);
