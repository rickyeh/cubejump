...
Title.prototype = {
    create: function() {
        ...
        // Add title image
        this.title = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - 200, 'title');
        this.title.anchor.set(0.5);

        // Add animating cube
        this.cube = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY + 50, 'ninja');
        this.cube.anchor.set(0.5);

        // Add tween animation to the cube
        this.tween = this.game.add.tween(this.cube)
        .to({ y: 275}, 250, Phaser.Easing.Exponential.Out, false, 3000)
        .to({ y: 425}, 400, Phaser.Easing.Exponential.In, true).loop().start();
